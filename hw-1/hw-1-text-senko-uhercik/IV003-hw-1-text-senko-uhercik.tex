...
Ak by bolo mozne deterministicky vybrat vzdy median tak by bol algoritmus vzdy linearny.\\

Median Of Medians

Median of medians: http://www.youtube.com/watch?v=QAbv\_4ndfo4\&list=PLLH73N9cB21W1TZ6zz1dLkyIm50HylGyg \\

1. Rozdel A do skupin po 5 prvkov O(n) \\
2. Zotried kazdu skupinu O(1) \\
3. C je pole tychto medianov tychto skupin O(1) \\
4. pivot = QSMoM(C, n/5) \\
